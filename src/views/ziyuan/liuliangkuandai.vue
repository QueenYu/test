		...
		<el-card shadow="hover">
			...
			<div style="display:flex;">
				<div style="text-align:left; width:50%;">
					<span v-if="radio2 == '带宽'">带宽峰值：0.00Mbps</span>
					<span v-if="radio2 == '流量'">总流量：0.00GB</span>
				</div>
			...
			<el-row :gutter="15" class="home-card-one mb15">
				<el-col>
					<div class="home-card-item" v-if="radio2 == '带宽'">
						<el-table :data="tableData.data" style="width: 100%">
							<el-table-column prop="roleName" label="域名" show-overflow-tooltip></el-table-column>
							<el-table-column prop="roleSign" label="峰值带宽" show-overflow-tooltip></el-table-column>
							<el-table-column prop="roleSign" label="峰值时刻" show-overflow-tooltip></el-table-column>
						</el-table>
					...
					<div class="home-card-item" v-if="radio2 == '流量'">
						<el-table :data="tableData.data" style="width: 100%">
							<el-table-column prop="roleName" label="域名" show-overflow-tooltip></el-table-column>
							<el-table-column prop="roleSign" label="流量" show-overflow-tooltip></el-table-column>
							<el-table-column prop="roleSign" label="流量占比" show-overflow-tooltip></el-table-column>
						</el-table>
						<el-pagination @size-change="onHandleSizeChange" @current-change="onHandleCurrentChange"
							class="mt15" :pager-count="5" :page-sizes="[10, 20, 30]"
							v-model:current-page="tableData.param.pageNum" background
