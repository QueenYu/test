<template>
	<div class="system-edit-role-container">
		<el-dialog title="修改融合线路信息" v-model="isShowDialog" width="569px">
			<el-form :model="ruleForm" size="default" label-width="150px">
				<el-form-item label="融合线路名称">
					<el-input v-model="ruleForm.roleName" placeholder="请输入融合线路名称" clearable>
					</el-input>
				</el-form-item>
				...
				<el-form-item label="融合线路CNAME域名">
					<el-input v-model="ruleForm.roleName" placeholder="请输入融合线路CNAME域名" clearable>
					</el-input>
				</el-form-item>
